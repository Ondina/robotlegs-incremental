...
package org.robotlegs.base
{
	...
	public class MediatorMap extends ViewMapBase implements IMediatorMap
	{
		...
		{
			trace("[RL  ] [MediatorMap] Constructor MediatorMap(contextView, injector, reflector)");
		...
		protected override function addListeners():void
		{
			...
			{
				trace("[RL  ] [MediatorMap] addListeners() if (contextView) contextView.addEventListener(Event.ADDED_TO_STAGE, onViewAdded)");
