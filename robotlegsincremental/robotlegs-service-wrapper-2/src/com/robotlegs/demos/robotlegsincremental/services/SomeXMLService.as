package com.robotlegs.demos.robotlegsincremental.services
{
    ...
    public class SomeXMLService extends Actor implements ISomeService
    {
        ...
        public function accessResources():void
        {
            ...
            registerListeners();
			trace("[Impl] [Service] SomeXMLService.accessResources()");
        ...
        {
			trace("[Impl] [Service] SomeXMLService.onServiceError(message)");
			unregisterListeners();
			urlLoader.close();			
			urlLoader=null;
            dispatch(new SomeErrorEvent(SomeErrorEvent.SOME_SERVICE_ERROR, message));
        }
