package com.robotlegs.demos.robotlegsincremental.controllers.commands.mappings
{
    ...
    public class MapControllersCommand extends Command
    {
        ...
        override public function execute():void
        {
            ...
            commandMap.mapEvent(SomeAlternativeServiceRequestEvent.ALTERNATIVE_DATA_REQUESTED, SomeAlternativeServiceRequestCommand, SomeAlternativeServiceRequestEvent, true);
